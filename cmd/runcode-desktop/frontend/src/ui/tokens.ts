...
export const BTN =
  'font-[inherit] border border-line2 bg-surface text-ink rounded-btn px-4 py-[9px] cursor-pointer transition hover:border-primary hover:text-primaryink disabled:opacity-40 disabled:cursor-default'
...
export const BTN_DANGER = '!text-red !border-red/40 hover:!text-red'
