...
const (
	...
	ReasonHarmJudgedSafe      Reason = "harm_judged_safe"
	ReasonFlightMode          Reason = "flight_mode"
	ReasonPlanMode            Reason = "plan_mode"
	ReasonJudgeAllowed        Reason = "judge_allowed"
	...
	ReasonWriteExists         Reason = "write_exists"
	ReasonUseDeleteTool       Reason = "use_delete_tool"
	ReasonPolicyDenied        Reason = "policy_denied"
	ReasonDenylisted          Reason = "denylisted"
	ReasonAllowedManage       Reason = "allowed_manage"
)
